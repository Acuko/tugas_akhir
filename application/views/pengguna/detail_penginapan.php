	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12">
				...
				<p class="text-white link-nav"><a href="<?php echo base_url('pengguna/dashboard') ?>"> Beranda </a> <span class="lnr lnr-arrow-right"></span> <a href="<?php echo base_url('pengguna/penginapan') ?>"> Penginapan</a><span class="lnr lnr-arrow-right"></span> <a href="#"> Detail Penginapan</a></p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row align-items-center">
			<?php foreach ($detail as $dt) : ?>
				...
				<div class="col-lg-6 insurence-right">
					<h1 class="text-uppercase"><?php echo $dt->nama_penginapan ?></h1>
 	...
 	<div class="modal-dialog" role="document">
 		<div class="modal-content">
			 ...
			 <form role="form" method="POST" action="<?= base_url('') ?>pengguna/penginapan/rating">
 			<div class="modal-body">
					...
					<?php for($i = 5; $i>=1; $i--){?>
                        ...
                        <?php }?>
						<input type="hidden" name="jenisid" id="jenisid" value="<?= $dt->id_penginapan ?>">
