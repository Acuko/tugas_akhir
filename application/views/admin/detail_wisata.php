			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-7">
						...
						<a class="btn btn-sm btn-danger ml-4" href="<?php echo base_url('data_wisata') ?>">Kembali</a>
						<a class="btn btn-sm btn-primary ml-3" href="<?php echo base_url('data_wisata/update_wisata/' . $dt->id_wisata) ?>">Update</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-8">
					<div class="row">
						...
						<br>
						<a href="<?php echo base_url('data_wisata/delete_foto/') , $dt->id ?>" class="btn btn-sm btn-danger"><i class=" fas fa-trash"></i></a>
							</div>
						<?php endforeach; ?>
				...
				<div class="col-md-4">
					<form method="POST" action="<?php echo base_url('data_wisata/tambah_gambar') ?>" enctype="multipart/form-data">
