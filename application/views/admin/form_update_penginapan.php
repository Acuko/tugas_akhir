 		...
 		<div class="card">
 			<div class="card-body">
 				...
 				<?php foreach ($penginapan as $mb) : ?>
 					<form method="POST" action="<?php echo base_url('data_penginapan/update_penginapan_aksi') ?>" enctype="multipart/form-data">
 						<div class="row">
 							<div class=" col-md-12">
 								<input type="hidden" name="id_penginapan" class="form-control" value=" <?php echo $mb->id_penginapan ?> ">

 								<div class="form-group">
 									<label>Nama Penginapan</label>
 									<input type="text" name="nama_penginapan" class="form-control" value=" <?php echo $mb->nama_penginapan ?> ">
 									<?php echo form_error('nama_penginapan', '<div class="text-small text-danger">', '</div>') ?>
 								</div>
 								...
 								<div class="form-group">
 									<label>Gambar</label>
									 <input type="hidden" name="foto_old" id="foto_old" class="form-control" value="<?php echo $mb->gambar ?>">
