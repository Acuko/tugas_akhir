	...
	<section class="section">
		...
		<table class="table table-hover " id="example">
			...
			<tbody>
				<?php
				$no = 1;
				foreach ($komentarw as $mb) : ?>
					<tr>
						<td class="align-middle"><?php echo $no++ ?></td>
						<td class="align-middle"><?php echo $mb->nama_wisata ?></td>
						<td class="align-middle text-uppercase"><?php echo $mb->nama ?></td>
						<td class="align-middle text-uppercase"><?php echo $mb->komentar ?></td>
						
						<td class="text-center align-middle">
							<a href="<?php echo base_url('data_komentar/hapus/') . $mb->id  ?>" class="btn btn-sm btn-danger"><i class=" fas fa-trash"></i></a>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
