 <div class="main-content">
 	<section class="section">
 		<div class="section-header">
 			<h1>Form Tambah SPBU</h1>
 		</div>

 		<div class="card">
 			<div class="card-body">
 				<form method="POST" action="<?php echo base_url('data_spbu/tambah_spbu_aksi') ?>" enctype="multipart/form-data">
 					<div class="row">
 						<div class=" col-md-12">

 							<div class="form-group">
 								<label>Nama SPBU</label>
 								<input type="text" name="nama_spbu" class="form-control" autocomplete="off">
