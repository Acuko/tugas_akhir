<div class="main-content">
	<section class="section">
		...
		<a href="<?php echo base_url('data_atm/tambah_atm') ?>" class="btn btn-primary mb-3">Tambah Data</a>
		<hr>
			...
			<tbody>
				...
				foreach ($atmu as $mb) : ?>
					<tr>
						...
						<td class="align-middle"><?php echo $mb->nama_atm ?></td>
						...
						<button  type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#viewmodal" 
							data-nama="<?= $mb->nama_atm ?>"
							data-alamat="<?= $mb->alamat ?>"
							data-gambar="<?= $mb->gambar ?>"
							data-deskripsi="<?= $mb->deskripsi ?>"
							> <i class=" fas fa-eye"></i></button>
							<a href="<?php echo base_url('data_atm/hapus/') . $mb->id_atm  ?>" class="btn btn-sm btn-danger"><i class=" fas fa-trash"></i></a>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Edit atm</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form action="<?= base_url('') ?>data_atm/update" method="post" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group">
						<label for="user">Nama atm</label>
						<input type="text" name="nama" id="nama" placeholder="Nama User" class="form-control" autocomplete="off" required>
						<input type="hidden" name="ids" id="ids" class="form-control" autocomplete="off" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="file" name="gambar" id="gambars" class="form-control" autocomplete="off" >
						<input type="hidden" name="gambar_old" id="gambar" class="form-control" autocomplete="off" required>
					</div>
