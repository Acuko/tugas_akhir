		...
		<div class="card">
			<div class="card-body">
				...
				<?php foreach ($wisata as $mb) : ?>
					<form method="POST" action="<?php echo base_url('data_wisata/update_wisata_aksi') ?>" enctype="multipart/form-data">
						<div class="row">
							<div class=" col-md-12">
								<input type="hidden" name="id_wisata" class="form-control" value=" <?php echo $mb->id_wisata ?> ">
